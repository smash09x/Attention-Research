"Runs OLS model A, B or C for both decay outcomes. Run: python model_main.py A"
...
"Each spec adds at most one YouTube predictor. DV is filled in per outcome."
MODEL_SPECS = {
...
if __name__ == '__main__':
    ...
    "Run twice: full peak width, then post-peak width."
